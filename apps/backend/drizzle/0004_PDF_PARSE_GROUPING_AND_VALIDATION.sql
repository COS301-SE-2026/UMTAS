...
CREATE TABLE "PARSE_JOB" (
	...
	"AdapterKey" character varying(64) NOT NULL,
	"FileKey" text,
	"ClientPdfStreamHash" character varying(64),
	"PdfStreamHash" character varying(64) NOT NULL,
	"FingerprintAlgorithm" character varying(128) NOT NULL,
...
ALTER TABLE "Course" ADD COLUMN "Degree" character varying(30);--> statement-breakpoint
