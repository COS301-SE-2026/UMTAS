CREATE TABLE "SOLVER_JOB" (
	...
	CONSTRAINT "SOLVER_JOB_UserID_user_id_fk" FOREIGN KEY ("UserID") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action
);
...
--> statement-breakpoint
CREATE UNIQUE INDEX "solver_job_duplicate_unique" ON "SOLVER_JOB" USING btree ("UserID","DeduplicationKey");
