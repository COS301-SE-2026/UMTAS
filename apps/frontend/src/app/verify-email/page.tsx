...
const steps = [
  {
    target: "#verify-email-card",
    content: "This page verifies the email address linked to your account.",
  },
  {
    target: "#verify-email-status",
    content: "Your current email verification status is displayed here.",
  },
];
