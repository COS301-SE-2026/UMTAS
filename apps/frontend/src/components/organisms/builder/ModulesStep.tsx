      ...
      <div key={module.id} className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg border border-[var(--border)] text-[var(--text-secondary)] transition-colors duration-[var(--duration-fast)] hover:border-[var(--error-text)] hover:text-[var(--error-text)]"
          >
        ...
        {isSelected && (
          <div className="flex flex-col gap-2 pl-2">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-lg border border-[var(--border)] bg-[var(--bg-surface)] py-2.5 text-sm font-medium text-[var(--text-primary)] transition-colors duration-[var(--duration-fast)] hover:bg-[var(--bg-elevated)]"
            >
