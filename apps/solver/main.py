...
app = FastAPI(
    title="UMTAS Solver",
    description="University Management Timetable & Scheduling System – Solver Service",
    version="1.0.0",
    docs_url=None,
    redoc_url=None,
)
...
async def custom_swagger_ui() -> HTMLResponse:
    return get_custom_swagger_html(openapi_url="/openapi.json", title="UMTAS Solver")
