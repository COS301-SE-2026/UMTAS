...
!!! abstract "Section Brief"
    This is the authoritative UMTAS design specification. Every token, rule, and component standard defined here must be followed exactly. Any deviation requires a deliberate decision documented in a PR. For a quick-reference summary see [Brand Style](Brand-Style.md).
