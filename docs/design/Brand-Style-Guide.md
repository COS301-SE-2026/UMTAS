# UMTAS Brand Style Guide

**Section 4.2.1 - Brand Style**  
**Project:** University Modular Timetable & Analytics System (UMTAS)  
**Team:** Vigil  
**Version:** 2.0  
**Date:** 11 May 2026
...
**Grid:** 12-column, 24px gutters, max-width 1280px, centered.
...
Motion is a design dimension. All transitions in UMTAS use consistent duration and easing tokens so state changes feel deliberate, not arbitrary.
...
- All CSS transitions must be suppressed under `prefers-reduced-motion: reduce` (see Section 7.3).
